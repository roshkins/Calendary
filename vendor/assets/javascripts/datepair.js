Calendary.setUpDatePair = function(topElSelector) {
	...
	topElSelector('.datepair input.date').each(function(){
		var $this = $(this);
		$this.datepicker({
	...
	topElSelector('.datepair input.time').each(function() {
		var $this = $(this);
	...
	topElSelector('.datepair').each(initDatepair);
